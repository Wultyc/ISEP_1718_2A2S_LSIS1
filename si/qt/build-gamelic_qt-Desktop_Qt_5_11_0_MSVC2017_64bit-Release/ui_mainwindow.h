...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        centralWidget->setMinimumSize(QSize(1000, 500));
        centralWidget->setMaximumSize(QSize(1000, 500));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushInserirEquipa->setText(QApplication::translate("MainWindow", "Inserir Equipa", nullptr));
